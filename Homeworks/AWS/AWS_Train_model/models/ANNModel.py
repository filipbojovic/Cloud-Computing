...
class ANN:
    ...
    def __init__(self, optimizer, batch_size, num_of_epochs, activation, output_activation, dataset_name): # dataset_name = 'filename.csv'
        ...
        self._dataset_name = dataset_name # ovo sam naknadno dodao kod zookeepera jer mi je sada potrebno da se dataset cuva.
    ...
    def save_model(self):
        ...
        os.mkdir(base_dir) # napravi folder da bi se unutar njega cuvao zip.
